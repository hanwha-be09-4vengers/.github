...
| :---------: | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   박경희    |  |프로젝트 전체 디자인과 나만의 레시피 구현을 담당해 주셨습니다. 통일감 있고 완성도 높은 결과물을 만들어 주셔서 감사합니다.
|   장민근    |  |
|   전기범    |  |
|   조창욱    |  |
|   최해관    |  |
...
| :---------: | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   박경희    |  |추천 서비스 기능을 담당해 주셨습니다. 유저의 취향에 맞춘 요리와 레시피 추천을 구현해 주셔서 감사합니다.
|   윤채연    |  |
|   장민근    |  |
|   조창욱    |  |
|   최해관    |  |
...
| :---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   박경희    | |서비스 알림 기능을 담당해 주셨습니다. 알림 서비스를 성공적으로 제공할 수 있게 해 주셔서 감사합니다.
|   윤채연    | |
|   전기범    | |
|   조창욱    | |
|   최해관    | |
...
| :---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   박경희    | |회원 관련 기능을 담당해 주셨습니다. 프로젝트의 회원 관련 기능과 보안 기능을 구현해 주셔서 감사합니다.
|   윤채연    | |
|   전기범    | |
|   장민근    | |
|   최해관    | |
...
| :---------: | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   박경희    | |나만의 레시피 기능을 담당해주셨습니다. 유저들이 정보를 공유할 수 있는 기능을 구현해 주셔서 감사합니다.
|   윤채연    | |
|   전기범    | |
|   장민근    | |
|   조창욱    | |
